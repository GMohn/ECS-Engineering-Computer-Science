...
class AppState
{
    ...
    constructor( )
    {
        ...
        this.ui_categories = {
            "Draw Mode":
            {
                "Discrete": document.getElementById( "discreteDrawMode" ),
                "Continuous": document.getElementById( "continuousDrawMode" ),
            },
            "Draw Shape":
            {
                "Point": document.getElementById( "pointDrawShape" ),
                "Triangle": document.getElementById( "triangleDrawShape" ),
                "Square": document.getElementById( "squareDrawShape" ),
            },
            "Canvas":
            {
        ...
        this.updateUI( "Draw Mode", "Discrete" )
        this.updateUI( "Draw Shape", "Triangle" )
    ...
    update( )
    {
        ...
        if ( Input.isKeyPressed( "d" ) ) {
            ...
            this.updateUI( "Draw Mode", "Continuous" )
        }
        ...
        if ( Input.isKeyPressed( "p" ) ) {
            this.updateUI( "Draw Shape", "Point" )
        } else if ( Input.isKeyPressed( "t" ) ) {
            this.updateUI( "Draw Shape", "Triangle" )
        } else if ( Input.isKeyPressed( "s" ) ) {
            this.updateUI( "Draw Shape", "Square" )
        }

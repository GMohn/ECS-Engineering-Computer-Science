...
app.get("/", (request, response) => {
  response.sendFile(__dirname + "/public/tiktokpets_v2.html");
});
...
app.post('/videoData',  (request, response) => {
  console.log("Dealing with the POST request: ", request.url);
  console.log("Body of request: ", request.body);

  console.log("Sending the request html...")
  response.send("acknowledge.html");
});

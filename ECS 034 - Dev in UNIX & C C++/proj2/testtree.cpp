...
TEST(FileSystemTree, EmptyTreeTest){
    ...
    std::cout <<"passed root-> fullpath" << std::endl;
...
TEST(FileSystemTree, AddChildTest){
    ...
    EXPECT_TRUE(Tree.Root()->AddPath("/home/cjnitta/ecs34"));
    EXPECT_FALSE(Tree.Root()->AddPath("home/cjnitta/ecs34"));
    EXPECT_TRUE(Tree.Root()->AddPath("home/cjnitta/ecs34/proj1"));
    EXPECT_TRUE(Tree.Root()->AddPath("home/cjnitta/ecs34/proj2"));
    EXPECT_TRUE(Tree.Root()->AddPath("home/cjnitta/ecs36c"));
...
TEST(FileSystemTree, IterateNodeTest){
    ...
    EXPECT_TRUE(Iter2->AddPath("../../bob"));
    EXPECT_FALSE(Tree.Root()->AddPath("/home/bob"));
    EXPECT_EQ(Iter2->FullPath(), "/home/cjnitta/ecs36c");
    EXPECT_FALSE(Iter2->AddPath("../../../../bob"));
}
...
TEST(FileSystemTree, AddDataTest){
    ...
    EXPECT_FALSE(Tree.Root()->AddPath("home/cjnitta/ecs34/proj1/failedchild"));
